  ...
  return <section className="py-24 bg-gradient-subtle">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {benefits.map((benefit, index) => <Card key={index} style={{
          animationDelay: `${index * 100}ms`
        }} className="p-6 hover:shadow-lg transition-all duration-300 hover:scale-105 border-border/50 animate-in fade-in slide-in-from-bottom duration-700 bg-gray-900">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-md">
          <div className="grid grid-cols-3 gap-6 text-center">
            ...
            <div className="border-r border-border last:border-r-0">
              ...
              <div className="text-muted-foreground bg-gray-950">satisfaction</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary mb-2">
                24/7
